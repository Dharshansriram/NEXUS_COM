...
async function runAiChat(messages, systemPrompt) {
  ...
  return `*(AI is not configured.)* Add **GEMINI_API_KEY** (free / recommended), **OPENAI_API_KEY**, or **LOVABLE_API_KEY** to your server \`.env\` file, restart the API, and try again.
